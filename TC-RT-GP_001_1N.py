# Тест-кейс: TC-RT-GP_001_1N
#
# Описание: Проверить, что при вводе клиентом некорректного номера
# телефона и корректного пароля система выдает сообщение: "Неверный логин или пароль".
#
# Ссылка на тест-кейс: https://docs.google.com/spreadsheets/d/1PE9EcK4a1cdgjxku7rX65zSYG03LKn5U/edit#gid=1535083511
#
...
from settings import invalid_number_phone, valid_password, close_confirm_and_cookies

def test_TC_RT_GP_001_1N(selenium):
   ...
   input_phone.send_keys(invalid_number_phone)
